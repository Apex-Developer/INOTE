                        ...
                        <div className="modal-body">
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input value={note.etitle} type="text" className="form-control"
                                        id="etitle" name='etitle' aria-describedby="emailHelp" onChange={onChange} />
                                </div>
